...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($_POST['genre']) or $_POST['genre'] == 0) {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO `events` (`event_name`, `event_date`, `event_hour`, `event_description`, `event_adress`, `event_emplacement`, `event_price`, `event_img`, `user_id`, `genre_id`) VALUES
                    (:name,
                     :date,
                     :hour,
                     :description,
